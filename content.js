...
// ⇒ `isYouTubeFamilyHost()` **لا `isYouTubeHost()`**: التضمينُ سطحٌ **يعملان فيه
// اليوم** (مقيسٌ في `S10`: الحاويةُ والمربّعاتُ تعملان في التضمين) ⇒ **وتضييقُه
// حذفُ حيّ.** ⛔ **وهي غير بوّابة #114**: هناك قِيس أن الميزة **ميتةٌ** في
// التضمين فضاقت، وهنا مقيسٌ أنها **حيّة** فاتّسعت — **والرقمُ واحد والقياسُ يفرّق.**
//
