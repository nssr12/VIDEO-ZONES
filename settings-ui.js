...
const VZ_UI_TIMING = [
  ...
  { id: "hideProgressBar", kind: "toggle",
    label: "إخفاء شريط تقدّم يوتيوب بعد سكون الفأرة",
    help: "يُخفي الشريط والخريطة الحرارية والعلامات والمِقبض وحدها — الوقت والأزرار تبقى. ويعود بأي حركة أو نقرة أو أمر. ⚠️ ولا يُخفى أثناء سحب الشريط ولا حين يكون التركيز عليه." },
