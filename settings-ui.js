...
const VZ_UI_TIMING = [
  ...
  { id: "hostBarEnabled", kind: "toggle", مدى: "متفاوت",
    أين: "لا يُرسم إلا حيث لا يُظهر المضيفُ أدواته أصلاً — ولا يُرسم على يوتيوب إطلاقاً.",
    label: "أظهِر شريطَ تقدّمٍ حيث لا شريطَ للموقع",
    help: "مواقعُ مثل تيك توك وإنستقرام تعرض الفيديو بلا شريط تقدّمٍ ولا أزرار، فلا سبيلَ إلى التنقّل فيه. وهذا يرسم شريطاً من عندنا فوق الفيديو: يظهر بحركة الفأرة ويختفي بالسكون، ويُسحَب للتنقّل. ⚠️ ولا يظهر حيث للموقع شريطُه — ولا على يوتيوب بحال. ⛔ ولا يعمل في البثّ المباشر: مدّةٌ غيرُ منتهية لا موضعَ فيها يُرسم." },
