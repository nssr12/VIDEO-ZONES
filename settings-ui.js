...
const VZ_UI_CLEAN = {
  ...
  quick_actions: { group: "overlays", measured: true,
    شريط: { جهة: "إجراءات", ترتيب: 1,
            أيقونات: ["quick_more", "quick_share", "quick_comments", "quick_dislike", "quick_like"] },
    label: "إخفاء الإجراءات السريعة",
    help: "⚠️ في ملء الشاشة وحدها: صفُّ الأزرار فوق شريط التقدّم — «مزيد من الإجراءات» و«مشاركة» و«التعليقات» و«عدم الإعجاب» و«الإعجاب». مقيسٌ 232×40 في ملء الشاشة، وdisplay:none في النافذة وفي قوائم التشغيل. ⚠️ ومفتاحٌ واحد يُخفيها كلَّها — لا مفتاحَ لكلّ زرّ." },
