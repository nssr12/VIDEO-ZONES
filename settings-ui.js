...
const VZ_UI_TIMING = [
  ...
  { id: "idleDuration", kind: "range", min: 500, max: 6000, step: 250, unit: "ms",
    label: "كم ينتظر قبل الإخفاء بعد أن تتوقّف الفأرة",
    help: "تُشارَك بين «إخفاء شريط تقدّم يوتيوب» و«زرّ السرعة». ⚠️ وأقلّها نصف ثانية، ولا تُطفئ شيئاً — الإطفاء بمفتاح الميزة وحده." },
  { id: "hideProgressBar", kind: "toggle",
    label: "إخفاء شريط تحكّم يوتيوب كلّه أسرع ممّا يُخفيه يوتيوب",
    help: "يُخفي الشريط السفلي بكامله — شريط التقدّم والوقت وأزرار التشغيل والصوت والترجمة والإعدادات وملء الشاشة. ويعود بأي حركة أو نقرة أو أمر. ⚠️ ولا يُخفى أثناء سحب الشريط ولا حين يكون التركيز على شيء منه." },
