...
const VZ_BAR_BUTTONS = [
  ...
  { id: "copy", label: "زرّ نسخ رابط الفيديو",
    help: "ينسخ ما في شريط العنوان منزوعاً منه الوقتُ وحدَه، ويؤكّد النسخ بشارةٍ قصيرة. ⚠️ وفي قائمة تشغيل تبقى القائمةُ في الرابط، فمن نسخ فيها شارك القائمةَ معها. ⚠️ ورابطُ Shorts يبقى كما هو إن أطفأتَ «تحويل Shorts إلى المشغّل العادي». ⚠️ ومدّةُ التأكيد من «كم يبقى رقم الصوت ظاهراً» — فإنزالُها إلى صفرٍ يُطفئ التأكيد، كشارة السرعة تماماً." }
];
