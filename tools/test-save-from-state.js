...
console.log("[1] ضابطٌ واحد ⇒ حقلٌ واحد");
{
  ...
  // ⚠️ **سبعةٌ بعد #107 لا ثمانية**: انتقل `hideProgressBar` إلى الـpopup بوضعٍ
  // ثلاثيّ. **والعددُ مشتقٌّ من سجلّ المُولِّد لا مكتوبٌ هنا** (قرار 34) —
  // فالتطابق مع `settings-ui.js` محروسٌ في التأكيد التالي، وهذا يمنع الفراغ.
  check("[1] وفيه ضوابطُ التوقيت السبعة", ids.length === 7, ids);
