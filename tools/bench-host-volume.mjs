...
// يكتب في `video.volume` على أربعة مضيفين أحياء ويقرأ ما يُعيدونه، والقيمةُ
//   المُستعادة نفسُها متباينةٌ مسجَّلة (‏56.2 … 83.6 ثم 100% شاذّة) — فأحمرُه
//   حقيقةُ مضيفٍ لا عطبٌ فينا، وإدخالُه البوّابةَ يُحمِّرها بما لا نملكه.
//
...
//
// ⛔ **ما يقيسه بالضبط (2026-08-04، تصنيف #105): نموذجُ المضيف لكتابةٍ لا يعلم
// بها** — يكتب في `video.volume` **مباشرةً وبلا إضافة**، **فأحمرُه حقيقةُ مضيفٍ
// لا عطبٌ فينا**. ⇒ **ولا يُقرأ «مُحيت» حكماً على محوّلنا**: قِيس 2026-08-04
// بمحوّلنا على المضيف نفسِه أن القيمة **تصمد إلى 8000ms وعبر دورة كتمٍ منه**.
//
// ⛔ **وعيبٌ فيه يُسجَّل ولم يُصلَح: يقرأ العنصر ولا يقرأ النموذج.**
// `yt-player-volume` في التخزين المحلّي هو الطرفُ الثاني من العلاقة — **ولو
// قُرئ معه لقال «تباعدا» بدل «مُحيت»**، ⭐ **ولَفسَّر الشاذّة المسجَّلة قبل
// ستّة أيام بدل أن يتركها «غير مفسَّرة»**.
// ⇒ ⭐ **والشكل الجامع: قياسُ طرفٍ من علاقةٍ يصف نتيجةً ولا يُسمّي سبباً.**
