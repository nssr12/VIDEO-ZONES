...
// محليٌّ بالكامل ولا يمسّ الشبكة، لكنه يُعلن في ترويسته أنه «تشخيصيّ لا حارس»،
//   ويسابق مؤقّتَ الخمول ذا الألفِ جزءٍ بفواصلَ من مئاتِ الأجزاء، وفيه بندٌ
//   (12ب) يُطبع «قِيس» بلا حكم.
//
