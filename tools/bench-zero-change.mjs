...
// شاهداه محليّان، لكنّ مقارنتَه الافتراضية أربعةُ مواقعَ حيّة في عشرِ تشغيلاتِ
//   كروم، ومحلُّه أصلاً قبولُ تغييرٍ يمسّ مسارَ الصوت — وعلى شجرةٍ نظيفة يقارن
//   HEAD بنفسه فيخضرّ بلا معنى.
//
