...
// ينقّل يوتيوب و d.tube حيّاً وينتظر تبديلَ عنصر الفيديو حتى ستّ عشرة ثانية
//   لكلّ انتقالٍ من خمسة، وأكثرُ الانتقالات لا يُبدّل العنصر أصلاً — فبوّابةٌ
//   تنتظره تدفع دقائق لتطبع «لم يقع».
//
