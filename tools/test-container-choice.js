...
// #58 لا يمسّها بنيوياً وتسقط إلى السكور — وهناك **يفوز `BODY`** فيُكبَّر `<body>`.
//
// ⚠️ تصحيح مقيس (2026-07-30): كان مكتوباً أن الاختيار «ينقلب بين مقاسَي إطار
// عرض». **قِيس فتبيّن أن الانقلاب كان أثر توقيت في منصّة القياس** (450ms لم تكفِ
// بعد `textContent=""` فبقي `body` بارتفاع 0 لحظةً فرُفض). بعد التصحيح: الاختيار
// **حتميّ على `BODY`** في كل المقاسات، والمميِّز الحقيقي **طول الصفحة** لا عرض
// إطار العرض — انظر `tools/repro-59-body.mjs`.
//
