...
// مسارُه الافتراضي صفحةُ يوتيوب، وقد رُصد أنها تردّ أحياناً بصفحة «حركة مرور
//   غير معتادة» بصفر فيديو — فالحمرة قد تكون من المضيف لا منّا؛ ولا يصير
//   محليّاً إلا بعَلَم `--local`.
//
